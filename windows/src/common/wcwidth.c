...
/*
** JOE and PuTTY both have implementations of wcwidth, which includes
** a long list of unicode mappings.  I've removed each implementation
** and placed them both here, to cut down on size.
*/
