...
do if exists("g:zenburn_high_Contrast")
...
dont if exists("g:zenburn_alternate_Visual")
...
dont if exists("g:zenburn_alternate_Error")
...
dont if exists("g:zenburn_alternate_Include")
    " original setting
